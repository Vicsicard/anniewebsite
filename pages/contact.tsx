    ...
    return {
      props: { 
        siteData: {
          site: {
            title: 'Annie Sicard',
            description: 'Contact Annie Sicard'
          }
        }
      },
    };
...
const ContactPage = ({ siteData }: { siteData: any }) => {
  ...
  return (
    <Layout 
      title="Contact Us" 
      description="Get in touch with Annie Sicard for web design and development services"
      siteData={siteData}
    >
      {/* Hero Section */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-md p-8 sticky top-8">
              <h2 className="text-2xl font-heading font-bold text-annie-dark mb-6">
                Contact Information
              </h2>
              ...
              <div className="space-y-6">
                {/* Email */}
                <div className="flex">
                  <div className="flex-shrink-0 h-12 w-12 flex items-center justify-center rounded-full bg-annie-primary/10 text-annie-primary">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-annie-dark">Email</h3>
                    <a href={`mailto:${contactDetails.email}`} className="text-gray-600 hover:text-annie-primary">
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-annie-dark">Phone</h3>
                    <a href={`tel:${contactDetails.phone.replace(/\D/g, '')}`} className="text-gray-600 hover:text-annie-primary">
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-annie-dark">Address</h3>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-annie-dark">Business Hours</h3>
                    <p className="text-gray-600">
              ...
              {/* Social Media */}
              <div className="mt-10">
                <h3 className="text-lg font-medium text-annie-dark mb-4">Connect With Us</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <button
                      ...
                      className="w-full py-3 px-6 bg-annie-primary text-white font-medium rounded-md hover:bg-annie-primary/90 transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
                    >
                      {status.submitting ? (
